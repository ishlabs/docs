...
{/* GENERATED FILE - do not edit by hand.
    Source: ishlabs/ish-cli @ command-tree (v0.33.1).
...
| [`ish workspace`](/cli/generated/workspace) | Manage workspaces | `list`, `create`, `get`, `update`, `delete`, `site-access`, `reference`, `info`, `use` |
| [`ish study`](/cli/generated/study-run) | Manage and run studies | `list`, `create`, `generate`, `get`, `results`, `update`, `delete`, `use`, `run`, `poll`, `wait`, `cancel`, `extend`, `participant`, `analyze`, `insights`, `benchmark`, `comparison`, `screenshots`, `share`, `unshare` |
...
| [`ish docs`](/cli/generated/docs) | Offline docs for agents - mental model, concept pages, search | `overview`, `intents`, `list`, `get-page`, `search` |
| [`ish commands`]() | Print the entire command tree as one machine-readable JSON manifest | None |
...
| [`ish account`]() | Account-level plan and credit usage | `usage` |
| [`ish telemetry`]() | Inspect backend LLM-call telemetry instrumentation (read-only dev endpoint) | `instrumentation`, `doctor` |
