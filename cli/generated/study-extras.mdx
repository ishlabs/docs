...
<ParamField path="--person <id>" type="string">Person ID Required.</ParamField>
...
<ParamField path="--persons <ids>" type="string">Comma-separated Person IDs/aliases; shortcut for --file with one participant per person (mutually exclusive with --file)</ParamField>
<ParamField path="--workspace <id>" type="string">Workspace ID; accepted for consistency (inferred from alias / active context)</ParamField>
...
<ParamField path="--wait" type="boolean">Poll until the run reaches completed, failed or insufficient_data</ParamField>
