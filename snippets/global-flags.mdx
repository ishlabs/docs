{/* GENERATED FILE - do not edit by hand.
    Source: ishlabs/ish-cli @ index.ts global options (v0.33.0).
...
<ParamField path="--list-fields" type="boolean">Print the projectable field names for the response instead of the data, then exit (also: --fields ?)</ParamField>
