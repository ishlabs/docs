...
appends a fresh round, replicates the source iteration's AI persona roster,
...
participants. The benchmark replicates that iteration's persona roster onto
...
whose completed persona roster each round replicates.
...
instructions: a persona could emit something shaped like a command - treat
